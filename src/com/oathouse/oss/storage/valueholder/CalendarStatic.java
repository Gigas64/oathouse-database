...
public class CalendarStatic {
    ...
    private CalendarStatic() {
    }

    /**
     * @return the current static locale display name
     */
    ...
    /**
     * @param localeName the locale as a string to set the static
     */
    public static void setLocale(String localeName) {
        LOCALE = new Locale(localeName == null || localeName.isEmpty() ? "en_GB" : localeName);
    }

    /**
     * @return the current static time zone display name
     */
    ...
    /**
     * @param timeZoneName the time zone as a string to set the static
     */
    public static void setTimeZone(String timeZoneName) {
        TIMEZONE = TimeZone.getTimeZone(timeZoneName == null || timeZoneName.isEmpty() ? "Europe/London" : timeZoneName);
    }
     ...
     */
    public static int[] getRelativeMonthStartEnd(int monthOffset) {
     ...
     */
    public static int getRelativeYW(int weekOffset) {
        Calendar c = getTzCal();
     ...
     * @return yw0 YWDHolder key value
     */
    public static int getRelativeYW(int yw0, int weekOffset) {
     ...
     * @return
     */
    public static int getRelativeYWD(int dayOffset) {
        Calendar c = getTzCal();
     ...
     * @return
     */
    public static int getRelativeYWD(int ywd, int dayOffset) {
        Calendar c = getTzCal(ywd);
        c.add(Calendar.DAY_OF_YEAR, dayOffset);
        return (getYWD(c));
    }
     ...
     * @return
     */
    public static int getRecentYWD(int ywd) {
        Calendar c = getTzCal(ywd);
        boolean leap = false;
     ...
     */
    public static int getRecentYWD(int mmDD, boolean isMonthDayPair) throws IllegalValueException {
        int month = mmDD/100;
     ...
     * @return
     */
    public static int getDayInterval(int ywd1, int ywd2) {
     ...
     */
    public static Calendar getTzCal(int ywd) {
     ...
     */
    public static long getTimestamp(int ywd) {
     ...
     */
    public static int getYWD(int year, int monthZeroToEleven, int dayOfMonth) throws IllegalValueException {
        Calendar c = getTzCal();
        c.set(Calendar.YEAR, year);
     ...
     * @throws IllegalValueException
     */
    public static int getYWDFromTimestamp(long timestamp) throws IllegalValueException {
        Calendar c = getTzCal();
     ...
     * @throws IllegalValueException
     */
    public static int getSDFromTimestamp(long timestamp) throws IllegalValueException {
        Calendar c = getTzCal();
        c.setTimeInMillis(timestamp);
     ...
     */
    public static int getYWD(Calendar date) {
     ...
     * @return
     */
    public static int getApproxYW0(int months) {
        int year = 0;
        if(months>=12) {
            year = months/12;
            months = months%12;
     ...
     * @return
     */
    public static int[] getAgeYearsMonths(int dobYwd) {
     ...
     * @return
     */
    public static int[] getAgeYearsMonths(int dobYwd, int onYwd) {
     ...
     * @return
     */
    public static int[] getAgeYearsMonths(int dobYwd, boolean futureAsNegatives) {
     ...
     * @return
     */
    public static int getAgeMonths(int dobYwd) {
     ...
     * @return
     */
    public static int getAgeMonths(int dobYwd, int onYwd) {
     ...
     * @return
     */
    public static int[] getAgeYearsMonths(int dobYwd, int onYwd, boolean futureAsNegatives) {
     ...
     * @throws IllegalValueException
     */
    public static int getWeekDifference(int firstYwd, int lastYwd) throws IllegalValueException {
     ...
     */
    public static Calendar getTzCal() {
